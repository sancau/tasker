...
},$scope.$on("$destroy",function(){self.renderUnknownOption=noop}),self.removeUnknownOption=function(){self.unknownOption.parent()&&self.unknownOption.remove()},self.readValue=function(){return self.removeUnknownOption(),$element.val()},self.writeValue=function(value){self.hasOption(value)?(self.removeUnknownOption(),$element.val(value),""===value&&self.emptyOption.prop("selected",!0)):null==value&&self.emptyOption?(self.removeUnknownOption(),$element.val("")):self.renderUnknownOption(value)},self.addOption=function(value,element){if(element[0].nodeType!==NODE_TYPE_COMMENT){assertNotHasOwnProperty(value,'"option value"'),""===value&&(self.emptyOption=element);var count=optionsMap.get(value)||0;optionsMap.put(value,count+1),self.ngModelCtrl.$render(),chromeHack(element)}},self.removeOption=function(value){var count=optionsMap.get(value);count&&(1===count?(optionsMap.remove(value),""===value&&(self.emptyOption=void 0)):optionsMap.put(value,count-1))},self.hasOption=function(value){return!!optionsMap.get(value)},self.registerOption=function(optionScope,optionElement,optionAttrs,interpolateValueFn,interpolateTextFn){if(interpolateValueFn){var oldVal;optionAttrs.$observe("value",function(newVal){isDefined(oldVal)&&self.removeOption(oldVal),oldVal=newVal,self.addOption(newVal,optionElement)})}else interpolateTextFn?optionScope.$watch(interpolateTextFn,function(newVal,oldVal){optionAttrs.$set("value",newVal),oldVal!==newVal&&self.removeOption(oldVal),self.addOption(newVal,optionElement)}):self.addOption(optionAttrs.value,optionElement);optionElement.on("$destroy",function(){self.removeOption(optionAttrs.value),self.ngModelCtrl.$render()})}}],selectDirective=function(){function selectPreLink(scope,element,attr,ctrls){var ngModelCtrl=ctrls[1];if(ngModelCtrl){var selectCtrl=ctrls[0];if(selectCtrl.ngModelCtrl=ngModelCtrl,element.on("change",function(){scope.$apply(function(){ngModelCtrl.$setViewValue(selectCtrl.readValue())})}),attr.multiple){selectCtrl.readValue=function(){var array=[];return forEach(element.find("option"),function(option){option.selected&&array.push(option.value)}),array},selectCtrl.writeValue=function(value){var items=new HashMap(value);forEach(element.find("option"),function(option){option.selected=isDefined(items.get(option.value))})};var lastView,lastViewRef=NaN;scope.$watch(function(){lastViewRef!==ngModelCtrl.$viewValue||equals(lastView,ngModelCtrl.$viewValue)||(lastView=shallowCopy(ngModelCtrl.$viewValue),ngModelCtrl.$render()),lastViewRef=ngModelCtrl.$viewValue}),ngModelCtrl.$isEmpty=function(value){return!value||0===value.length}}}}function selectPostLink(scope,element,attrs,ctrls){var ngModelCtrl=ctrls[1];if(ngModelCtrl){var selectCtrl=ctrls[0];ngModelCtrl.$render=function(){selectCtrl.writeValue(ngModelCtrl.$viewValue)}}}return{restrict:"E",require:["select","?ngModel"],controller:SelectController,priority:1,link:{pre:selectPreLink,post:selectPostLink}}},optionDirective=["$interpolate",function($interpolate){return{restrict:"E",priority:100,compile:function(element,attr){if(isDefined(attr.value))var interpolateValueFn=$interpolate(attr.value,!0);else{var interpolateTextFn=$interpolate(element.text(),!0);interpolateTextFn||attr.$set("value",element.text())}return function(scope,element,attr){var selectCtrlName="$selectController",parent=element.parent(),selectCtrl=parent.data(selectCtrlName)||parent.parent().data(selectCtrlName);selectCtrl&&selectCtrl.registerOption(scope,element,attr,interpolateValueFn,interpolateTextFn)}}}}],styleDirective=valueFn({restrict:"E",terminal:!1}),requiredDirective=function(){return{restrict:"A",require:"?ngModel",link:function(scope,elm,attr,ctrl){ctrl&&(attr.required=!0,ctrl.$validators.required=function(modelValue,viewValue){return!attr.required||!ctrl.$isEmpty(viewValue)},attr.$observe("required",function(){ctrl.$validate()}))}}},patternDirective=function(){return{restrict:"A",require:"?ngModel",link:function(scope,elm,attr,ctrl){if(ctrl){var regexp,patternExp=attr.ngPattern||attr.pattern;attr.$observe("pattern",function(regex){if(isString(regex)&&regex.length>0&&(regex=new RegExp("^"+regex+"$")),regex&&!regex.test)throw minErr("ngPattern")("noregexp","Expected {0} to be a RegExp but was {1}. Element: {2}",patternExp,regex,startingTag(elm));regexp=regex||void 0,ctrl.$validate()}),ctrl.$validators.pattern=function(modelValue,viewValue){return ctrl.$isEmpty(viewValue)||isUndefined(regexp)||regexp.test(viewValue)}}}}},maxlengthDirective=function(){return{restrict:"A",require:"?ngModel",link:function(scope,elm,attr,ctrl){if(ctrl){var maxlength=-1;attr.$observe("maxlength",function(value){var intVal=toInt(value);maxlength=isNaN(intVal)?-1:intVal,ctrl.$validate()}),ctrl.$validators.maxlength=function(modelValue,viewValue){return maxlength<0||ctrl.$isEmpty(viewValue)||viewValue.length<=maxlength}}}}},minlengthDirective=function(){return{restrict:"A",require:"?ngModel",link:function(scope,elm,attr,ctrl){if(ctrl){var minlength=0;attr.$observe("minlength",function(value){minlength=toInt(value)||0,ctrl.$validate()}),ctrl.$validators.minlength=function(modelValue,viewValue){return ctrl.$isEmpty(viewValue)||viewValue.length>=minlength}}}}};return window.angular.bootstrap?void(window.console&&console.log("WARNING: Tried to load angular more than once.")):(bindJQuery(),publishExternalAPI(angular),angular.module("ngLocale",[],["$provide",function($provide){function getDecimals(n){n+="";var i=n.indexOf(".");return i==-1?0:n.length-i-1}function getVF(n,opt_precision){var v=opt_precision;void 0===v&&(v=Math.min(getDecimals(n),3));var base=Math.pow(10,v),f=(n*base|0)%base;return{v:v,f:f}}var PLURAL_CATEGORY={ZERO:"zero",ONE:"one",TWO:"two",FEW:"few",MANY:"many",OTHER:"other"};$provide.value("$locale",{DATETIME_FORMATS:{AMPMS:["AM","PM"],DAY:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],ERANAMES:["Before Christ","Anno Domini"],ERAS:["BC","AD"],FIRSTDAYOFWEEK:6,MONTH:["January","February","March","April","May","June","July","August","September","October","November","December"],SHORTDAY:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],SHORTMONTH:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],STANDALONEMONTH:["January","February","March","April","May","June","July","August","September","October","November","December"],WEEKENDRANGE:[5,6],fullDate:"EEEE, MMMM d, y",longDate:"MMMM d, y",medium:"MMM d, y h:mm:ss a",mediumDate:"MMM d, y",mediumTime:"h:mm:ss a","short":"M/d/yy h:mm a",shortDate:"M/d/yy",shortTime:"h:mm a"},NUMBER_FORMATS:{CURRENCY_SYM:"$",DECIMAL_SEP:".",GROUP_SEP:",",PATTERNS:[{gSize:3,lgSize:3,maxFrac:3,minFrac:0,minInt:1,negPre:"-",negSuf:"",posPre:"",posSuf:""},{gSize:3,lgSize:3,maxFrac:2,minFrac:2,minInt:1,negPre:"-¤",negSuf:"",posPre:"¤",posSuf:""}]},id:"en-us",localeID:"en_US",pluralCat:function(n,opt_precision){var i=0|n,vf=getVF(n,opt_precision);return 1==i&&0==vf.v?PLURAL_CATEGORY.ONE:PLURAL_CATEGORY.OTHER}})}]),void jqLite(window.document).ready(function(){angularInit(window.document,bootstrap)}))}(window),!window.angular.$$csp().noInlineStyle&&window.angular.element(document.head).prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\\:form{display:block;}.ng-animate-shim{visibility:hidden;}.ng-anchor{position:absolute;}</style>')},function(module,exports){"use strict";var appConfig=function($stateProvider,$urlRouterProvider){$urlRouterProvider.otherwise("/tasks"),$stateProvider.state("app",{url:"/",templateUrl:"views/app.view.html"}).state("app.tasks",{url:"tasks",controller:"tasksCtrl as vm",templateUrl:"views/tasks.view.html"}).state("app.types",{url:"types",controller:"typesCtrl as vm",templateUrl:"views/types.view.html"}).state("app.newtask",{url:"newtask",controller:"newTaskCtrl as vm",templateUrl:"views/newtask.view.html",resolve:types}).state("app.newtype",{url:"newtype",controller:"newTypeCtrl as vm",templateUrl:"views/newtype.view.html"}).state("app.itemslist",{url:"itemslist",controller:"itemsListCtrl as vm",templateUrl:"views/itemslist.view.html",resolve:itemslist})},productionURL="http://139.59.144.80/api";angular.module("app",["ui.router","ui.bootstrap","ngAnimate"]).config(["$stateProvider","$urlRouterProvider",appConfig]).constant("BASE_API_URL",productionURL);var types={types:["Collection",function(Collection){var c=new Collection("types");return c.getAll().then(function(res){return res.data},function(e){return console.error(e)})}]},itemslist={items:["Collection",function(Collection){var c=new Collection("items");return c.getAll().then(function(res){return res.data},function(e){return console.error(e)})}],categories:["Collection",function(Collection){var c=new Collection("categories");return c.getAll().then(function(res){return res.data},function(e){return console.error(e)})}]}},function(module,exports){"use strict";var appCtrl=function($state){var vm=this;return vm.title="YANA",vm.isActive=function(stateName){return stateName===$state.current.name},vm};angular.module("app").controller("appCtrl",["$state",appCtrl]);var tasksCtrl=function(Collection){var vm=this,c=new Collection("tasks");return c.getAll().then(function(response){return vm.tasks=response.data},function(error){return console.error(error)}),vm.confirmTask=function(task){task.isConfirmed=!0,c.save(task).then(function(res){console.log("task saved.")},function(err){return console.log(err)})},vm.deleteTask=function(task){c.remove(task).then(function(res){var index=vm.tasks.indexOf(task);index>-1&&vm.tasks.splice(index,1)},function(err){return console.log(err)})},vm};angular.module("app").controller("tasksCtrl",["Collection",tasksCtrl]);var typesCtrl=function(Collection){var vm=this,c=new Collection("types");return c.getAll().then(function(response){return vm.types=response.data},function(error){return console.error(error)}),vm.deleteType=function(type){c.remove(type).then(function(res){var index=vm.types.indexOf(type);index>-1&&vm.types.splice(index,1)},function(err){return console.log(err)})},vm.updateType=function(type){c.save(type).then(function(res){vm.togleEditType(type)},function(err){return console.log(err)})},vm.togleEditType=function(type){type.editMode=!type.editMode},vm};angular.module("app").controller("typesCtrl",["Collection",typesCtrl]);var newTaskCtrl=function($state,types,Collection){var vm=this,c=new Collection("tasks");return vm.typeOptions=types,console.log(types),vm.saveTask=function(){var newTask={type:vm.type,room:vm.room,comment:vm.comment};c.save(newTask).then(function(res){$state.go("app.tasks")},function(err){return console.log(err)})},vm};angular.module("app").controller("newTaskCtrl",["$state","types","Collection",newTaskCtrl]);var newTypeCtrl=function($state,Collection){var vm=this,c=new Collection("types");return vm.newType={},vm.saveType=function(){c.save(vm.newType).then(function(res){$state.go("app.types")},function(err){return console.log(err)})},vm.goBack=function(){return $state.go("app.types")},vm};angular.module("app").controller("newTypeCtrl",["$state","Collection",newTypeCtrl]);var itemsListCtrl=function(items,categories,Collection){var vm=this;vm.items=items,vm.categories=categories;var _iteratorNormalCompletion=!0,_didIteratorError=!1,_iteratorError=void 0;try{for(var _step,_loop=function(){var category=_step.value;category.items=vm.items.filter(function(i){return i.category===category._id})},_iterator=vm.categories[Symbol.iterator]();!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=!0)_loop()}catch(err){_didIteratorError=!0,_iteratorError=err}finally{try{!_iteratorNormalCompletion&&_iterator["return"]&&_iterator["return"]()}finally{if(_didIteratorError)throw _iteratorError}}return vm.toggleEditItemMode=function(){vm.editItemMode=!vm.editItemMode},vm.toggleEditCategoryMode=function(){vm.editCategoryMode=!vm.editCategoryMode},vm.confirmItem=function(item){item.confirmed=!0;var c=new Collection("items");c.save(item).then(function(r){return item.confirmed=!1},function(e){return console.error(e)})},vm.toggleNewCategoryMode=function(){return vm.newCategoryMode=!vm.newCategoryMode},vm.newCategory={},vm.addCategory=function(){var c=new Collection("categories");c.save(vm.newCategory).then(function(res){res.data.items=[],vm.categories.push(res.data),vm.newCategory={},vm.toggleNewCategoryMode()},function(err){return console.error(err)})},vm.toggleNewItemMode=function(category){category.newItemMode=!category.newItemMode,category.newItem={}},vm.addItem=function(category){var c=new Collection("items");category.newItem.category=category._id,c.save(category.newItem).then(function(res){category.items.push(res.data),category.newItem={},vm.toggleNewItemMode(category)},function(err){return console.error(err)})},vm.getCategoryHeading=function(category){var itemsCount=null==category.items?0:category.items.length,confirmedCount=null==category.items?0:category.items.filter(function(v){return v.confirmed}).length;return category.name+" ("+confirmedCount+" / "+itemsCount+")"},vm.toggleCategoryDetails=function(category){category.expanded=null==category.expanded||!category.expanded},vm.confirmItem=function(item){var c=new Collection("items");item.confirmed=!0,c.save(item).then(function(r){return!0},function(e){return console.error(e)})},vm.deleteItem=function(item,category){var c=new Collection("items");c.remove(item).then(function(r){var index=category.items.indexOf(item);index>-1&&category.items.splice(index,1)},function(e){return console.error(e)})},vm.deleteCategory=function(category){console.log(category);var c=new Collection("categories");c.remove(category).then(function(r){var index=vm.categories.indexOf(category);index>-1&&vm.categories.splice(index,1)},function(e){return console.error(e)})},vm};angular.module("app").controller("itemsListCtrl",["items","categories","Collection",itemsListCtrl])},function(module,exports){"use strict"},function(module,exports){"use strict";var Collection=function($http,BASE_API_URL){return function(endpoint){var service={};return service.getAll=function(){return $http.get(BASE_API_URL+"/"+endpoint)},service.getOne=function(id){return $http.get(BASE_API_URL+"/"+endpoint+"/"+id)},service.save=function(data){return data._id?$http.put(BASE_API_URL+"/"+endpoint+"/"+data._id,data):$http.post(BASE_API_URL+"/"+endpoint,data)},service.remove=function(data){return $http({method:"DELETE",url:BASE_API_URL+"/"+endpoint+"/"+data._id,headers:{"Content-Type":"application/json;charset=utf-8"}})},service}};angular.module("app").service("Collection",["$http","BASE_API_URL",Collection])}]);